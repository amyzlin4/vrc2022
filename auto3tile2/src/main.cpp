...
void auto2v2() {
  ...
  driveL.spin(forward,65,percent);
  driveR.spin(forward,65,percent);
  wait(0.85, sec); // 1.1 at 50
  driveL.stop();
  driveR.stop();
  wait(0.1, sec);
  intake.spin(forward,12,voltageUnits::volt);
  driveL.spin(forward,12,percent);
  driveR.spin(forward,12,percent);
  wait(1.92,sec); // 1.5 at 15
