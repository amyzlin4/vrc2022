...
void driver() {
  ...
  driveL.setVelocity((0-Controller1.Axis3.position(percent)) + Controller1.Axis1.position(percent), percent);
  driveR.setVelocity((0-Controller1.Axis3.position(percent)) - Controller1.Axis1.position(percent), percent);
  driveL.spin(forward);
  driveR.spin(forward);
}
...
void ind() {
  ...
  wait(200,msec);
  indexer.spinFor(reverse,100,degrees);
}
void intaker() {
